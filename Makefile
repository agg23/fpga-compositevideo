...
# Synthesis
synthesis.json: top_counts.v counts.v pll.v vendor/rpll.v vendor/GW1N-9C-dyn.vh tangnano9k.cst
	yosys -p "read_verilog top_counts.v counts.v vendor/GW1N-9C-dyn.vh pll.v vendor/rpll.v; synth_gowin -noalu -nowidelut -nolutram -nodffe -top top -json synthesis.json"
