...
# Synthesis
synthesis.json: top.v pll.v vendor/rpll.v tangnano9k.cst
	yosys -p "read_verilog top.v pll.v vendor/rpll.v; synth_gowin -noalu -nowidelut -nolutram -nodffe -top top -json synthesis.json"
